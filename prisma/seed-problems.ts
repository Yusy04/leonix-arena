        ...
        create: [
          {
            ...
            statement: "<p>Se dă un șir de <strong>N</strong> numere. Determinați <em>suma</em> elementelor.</p>",
            inputSpec: "<p>Prima linie conține <code>N</code>. A doua linie conține <code>N</code> numere.</p>",
            outputSpec: "<p>Suma celor <code>N</code> numere.</p>",
            constraints: "<ul><li>1 ≤ N ≤ 1000</li></ul>",
          },
          {
            language: "en", title: "Sequence 3", published: true,
            statement: "<p>Given a sequence of <strong>N</strong> numbers, compute the <em>sum</em> of its elements.</p>",
            inputSpec: "<p>The first line contains <code>N</code>. The second line contains <code>N</code> numbers.</p>",
            outputSpec: "<p>The sum of the <code>N</code> numbers.</p>",
            constraints: "<ul><li>1 ≤ N ≤ 1000</li></ul>",
          },
        ],
      },
